# Interview Guide — Deep Evidence Extraction
...
### Starting from a GTV Profile

If the user pastes a GTV Profile artifact:
1. Parse it completely — don't re-ask questions already answered
2. Confirm the pathway (Talent/Promise) and target criteria
3. Review the evidence inventory — which items to keep, cut, or probe deeper
4. Note any gaps or risks flagged in the profile
5. Start Phase 1 from the evidence strategy, not from scratch
...
For each potential evidence item, ask:
- **What exactly happened?** (not "I led a project" but "I built X that did Y")
...
Extract bullet points organized by section:

**Section 1: Background & Journey**
- How did you enter digital tech? What's the origin story?
- What drives your work? What's the through-line?
- What's your current role and focus?

**Section 2: Key Achievements & Innovation**
- What's the most impactful thing you've built/done? Walk me through it.
- What was technically innovative about your approach?
- What measurable impact did it have? (be specific — exact numbers)
- What would have happened if you hadn't done this? (counterfactual)
- What's the story you want assessors to remember? If they could only remember one thing about your application, what should it be?
- What makes your trajectory unusual compared to someone with a similar title?

**Section 3: External Recognition**
- How has the industry recognized your work?
- Speaking invitations, awards, press coverage?
- Leadership roles in communities, standards bodies, open source?
...
- Data/analytics (what metrics? source?)
- Press articles (which publications? dates?)
- Third-party letters or confirmations
- GitHub/portfolio links

**The story**: Walk me through what happened.
...
- "When you say 'led,' what did that actually look like day-to-day?"
- "You mentioned growth — from what to what? Over what time period?"
- "Who would remember this? Is there any documentation?"
- "If I looked at this from the outside, what would I see?"

### Flagging Weak Evidence
Be direct about weakness:
- "This is interesting but without metrics it'll be hard to make compelling"
- "An assessor might look at this and think 'so what?' — what makes it exceptional?"
- "This sounds like standard good work, not exceptional. Can you think of what made it stand out?"

### Drawing Out What People Forget
Common blind spots:
- Press coverage they didn't think was significant
- Conference talks (even lightning talks at good conferences)
- Mentoring or community contributions
- Side projects with unexpected traction
- Awards or nominations they dismissed
...
- GitHub analytics: stars, forks, contributors, download counts
