...
- [bullet point about industry recognition]
- [bullet point]
- [bullet point]

### Section 4: Why the UK & Future Plans
- [bullet point about specific UK plans]
- [bullet point]
- [bullet point]
...
*Target: max 3 pages. Focus on impact, not responsibilities.*
...
4. [Achievement with measurable outcome]
5. [Achievement with measurable outcome]
...
### Products Shipped
| Product | Your Contribution | Impact |
|---|---|---|
| [name] | [what you did] | [metrics] |

### Open Source
| Project | Role | Metrics |
|---|---|---|
| [name] | [role] | [stars/forks/downloads] |
...
- [Screenshot/document 2 — what it shows]
- [Data point — source]
...
*Only include this section if gaps were identified that could be addressed before submission.*
...
### Dates
| Role/Event | Date Used | Appears In |
|---|---|---|
| [Role at Company] | [Month/Year – Month/Year] | CV, Personal Statement, Evidence Doc X |
| [Conference talk] | [Month/Year] | CV, Evidence Doc Y, Letter 2 |
| ... | | |

### Company Names
| Company | Exact Name to Use | Notes |
|---|---|---|
| [company] | [exact name] | [e.g., "Use 'Google LLC' everywhere, not 'Alphabet'"] |

### Key Metrics
| Metric | Exact Value | Appears In |
|---|---|---|
