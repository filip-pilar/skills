...
Use execution comparisons when a behavioral claim warrants them or the user requests them. Routine wording and structural edits do not need a benchmark framework.
...
Report the scenarios and checks actually run, their results, and what they cannot establish. One successful run does not prove reliability; source inspection is not execution evidence.
