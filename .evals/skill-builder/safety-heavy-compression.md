...
- Strongest completed evidence: level 3, isolated read-only fixture execution against a real pinned package. Replace or repair this target before using the case as clean-compression evidence.
