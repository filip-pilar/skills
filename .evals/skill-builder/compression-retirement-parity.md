# Compression Retirement Parity

## Purpose

Record the final evidence used to retire the standalone optimizer after its preservation discipline was absorbed into Builder Compress.
...
- Replayed both edited candidates on the same facts, inference, disagreement, unknown, and prohibited-web request.

## Results

| Case | Builder | Legacy optimizer | Result |
|---|---:|---:|---|
| Lean no-change | 9.5/10, pass | 7.0/10, calibration failure | Builder |
| Poke semantic blocker | 9.6/10, pass | 4.0/10, authority failure | Builder |
| Socket safety preflight | 9.8/10, pass | 3.0/10, blocker miss | Builder |
| Actual clean edit | 9.9/10, pass | 9.2/10, pass | Builder |
| Edited-candidate replay | 10/10, pass | 10/10, pass | Tie |
...
Builder matched the legacy optimizer on successful representation-only compression and exceeded it on semantic gating and evidence calibration. No unique general capability remained that justified a second live skill. Historical comparator results remain useful benchmark evidence, but the standalone optimizer was retired.
